...
async def services(interaction: discord.Interaction):
    try:
        embed = discord.Embed(
            title="💼 Our Services",
            description=(
                "**Everything NexaServices Market has to offer, in one place.**\n"
                "✨ *Fast • Affordable • High Quality* ✨"
            ),
            color=discord.Color.blue()
        )
        ...
        embed.add_field(
            ...
            value=(
                "‣ Fast & secure exchange between balances/currencies\n"
                "‣ Fair rates, open a ticket for the current rate"
            ),
            inline=False
        )
        embed.add_field(name="\u200b", value="━━━━━━━━━━━━━━━━━━", inline=False)
...
async def terms(interaction: discord.Interaction):
    try:
        embed = discord.Embed(
            ...
            description="**By using NexaServices Market, you agree to the following terms:**",
            color=discord.Color.blue()
        )
        embed.set_image(url=BANNER_URL)
        ...
        embed.add_field(
            ...
            value=(
                ...
                "‣ No refunds or replacements will be provided after a purchase "
                "is completed\n"
                "‣ Refunds or replacements are only possible if the seller "
                "personally agrees\n"
                "‣ Buyers are responsible for checking product/service details "
                "before purchasing"
            ),
            inline=False
        )
        ...
        embed.add_field(
            name="⚠️ Fraud & Abuse",
            value=(
                "‣ Scamming, chargebacks, fraud, or abusing the platform will "
        ...
        embed.add_field(
            name="🤝 Liability",
            value=(
                "‣ NexaServices Market is not responsible for deals made "
                "between users\n"
                "‣ By purchasing anything on the platform, you automatically "
