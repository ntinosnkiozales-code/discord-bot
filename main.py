...
async def setup_tickets(interaction: discord.Interaction):
    try:
        ...
        title_embed.set_image(url=BANNER_URL)
        ...
        intro_embed.set_thumbnail(url=BANNER_URL)
        intro_embed.set_footer(text="NexaServices | All rights reserved")

        await interaction.channel.send(embeds=[title_embed, intro_embed])
