...
BANNER_URL = "https://cdn.discordapp.com/attachments/1505527779184345158/1547359648997314802/A09EDD89-9C12-464C-AD35-57CF50FF1B5C.png?ex=6aa32278&is=6aa1d0f8&hm=b6b2ebe2806cf868f0910ac9463272460a75642f449111c6941f2202a9cfa52d&"
...
class TicketView(discord.ui.View):
    ...
    @discord.ui.button(label="Support", emoji="📞", style=discord.ButtonStyle.primary, custom_id="open_ticket_support")
    ...
    @discord.ui.button(label="Buy", emoji="🛒", style=discord.ButtonStyle.primary, custom_id="open_ticket_buy")
...
async def setup_tickets(interaction: discord.Interaction):
    try:
        embed = discord.Embed(
            title="🎫 Marketplace Ticket",
            description=(
                "Need assistance? Choose a category below to open a ticket — "
                "our staff team will assist you shortly!\n\n"
                "📞 **Support Ticket**\n"
                "If you need help, have a problem, or need a replacement, click **Support**.\n\n"
                "🛒 **Buy Ticket**\n"
                "Looking to make a purchase? Click **Buy** and our team will guide you through your order."
            ),
            color=discord.Color.blue()
        )
